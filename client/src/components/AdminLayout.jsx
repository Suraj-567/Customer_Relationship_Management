  ...
  // ---------------------
  // This component defines the main layout structure for the admin panel,
  // including a fixed sidebar with navigation links and a main content area
  // rendered through React Router's <Outlet />.
 
  // Features:
  //  Highlights the active route based on the current URL.
  // Provides navigation to the dashboard, approvals, and approved companies.
  // Includes a logout button that clears the auth token and redirects to login.
  // Styled using TailwindCSS with a glassmorphism-like aesthetic.
